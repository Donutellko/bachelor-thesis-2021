...
\begin{enumerate}[1.]
	...
	\item Исходные данные по работе: \uline{Описания и спецификации современных подходов к организации взаимодействия между клиентом и сервером, таких как REST (диссертация Роя Филдинга), GraphQL (официальная спецификация) и SOAP (обзорная статья). А также статьи об их достоинствах и недостатках, сравнения этих подходов между собой}.%
	...
	\begin{enumerate}[label=\theenumi\arabic*.]
		\item Обоснование актуальности разработки указанного сервиса-адаптера.
	...
	\begin{enumerate}[label=\theenumi\arabic*.]
		\item Внутренняя архитектура сервиса. % TODO
		\item Схема взаимодействия сервиса с информационной системой % TODO
	\end{enumerate}
